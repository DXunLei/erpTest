		...
		<div class="content">
			<div class="left">
				<div style="margin-left:2px;">
					<img src="<%=base%>/images/left-top.gif" width="162" height="25" />
				</div>
				<div class="left-bottom">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						   ...
						   <tr>
							...
							<tr>
								<td><a class="hei" target="main" href="<%=base %>/order/in/inList.do">&nbsp;&nbsp;&nbsp;&nbsp;采购订单</a></td>
							</tr>
				
							<tr>
								<td><a class="hei" target="main" href="<%=base %>/order/in/inApproveList.do">&nbsp;&nbsp;&nbsp;&nbsp;采购审批</a></td>
							</tr>
							...
							<tr>
								<td><a class="hei" target="main" href="<%=base %>/employee/list.do">&nbsp;&nbsp;&nbsp;&nbsp;员工维护</a></td>
							</tr>
		...
		<div class="footer">
			<div style="margin-top:5px;">
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					align="center">
					<tr>
						<td width="82%"><img src="<%=base%>/images/icon_1.gif" />&nbsp; <a
							class="lanyo" href="www.itcast.cn">蓝源信息技术 2014</a></td>
						<td width="18%" valign="middle"><img src="<%=base%>/images/icon_2.gif" />&nbsp;
