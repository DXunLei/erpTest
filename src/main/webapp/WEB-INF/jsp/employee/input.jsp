  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="18%"align="center" name="name">真实姓名</td>
				      <td width="32%">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<input type="text" size="25" name="pwd"/>
				      </td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<input type="text" size="25" name="tele"/>
					  </td>
				     </tr>
				      <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
			...
			<div class="order-botton">
				<div style="margin:1px auto auto 1px;">
					<table width="100%"  border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td>
					    	<a href="javascript:document.forms[0].submit()"><img src="<%=base%>/images/order_tuo.gif" border="0" /></a>
					    </td>
					    <td>&nbsp;</td>
